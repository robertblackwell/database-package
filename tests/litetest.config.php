...
return [
	...
	// "fred" =>[
		...
		// "unit_tests/find_items/find_item_test.php",

		// "unit_tests/models/get_by_slug/get_by_slug_test.php",
		...
		// "unit_tests/paths/path_test.php",
